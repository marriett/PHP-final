...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-5 col-sm-6">
            ...
            <form action="alterarItemNoBanco.php" method="POST" id="item">
                <input class="esconder" type="" name="idI" value="<?php  echo $id ?>">
                <br>
                <label>Nome:</label>
                ...
                <br>
                <input class="form-control" type="submit" name="cadastrar" value="Atualizar" required>
            </form>
            <br>
